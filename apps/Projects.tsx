...
export default function Projects() {
	return (
		<section className="p-6">
			<article className="flex min-h-[280px] flex-col rounded-lg border border-[#d0d7de] bg-white/68 p-5 shadow-sm backdrop-blur-xl">
				<div className="space-y-3">
					<div className="flex items-start justify-between gap-4">
						<div>
							<p className="font-mono text-xs uppercase tracking-widest text-[#667085]">Featured Project</p>
							<h2 className="mt-2 font-mono text-xl text-[#1f2933]">Linux Desktop Portfolio</h2>
						</div>
						<span className="rounded-md border border-[#99c1f1] bg-[#eaf4ff] px-2 py-1 font-mono text-xs text-[#1c71d8]">
							In development
						</span>
					</div>
					<p className="max-w-xl text-sm leading-relaxed text-[#384250]">
